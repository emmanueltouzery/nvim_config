...
vim.keymap.set("n", "<leader>ctf", "<cmd>lua require('neotest').run.run(vim.fn.expand('%'))<cr>", {desc="test file"})
vim.keymap.set("n", "<leader>ctn", "<cmd>lua require('neotest').run.run()<cr>", {desc="test nearest"})
vim.keymap.set("n", "<leader>cta", "<cmd>lua require('neotest').run.run('.')<cr>", {desc="test all"})
vim.keymap.set("n", "<leader>ctl", "<cmd>lua require('neotest').run.run_last()<cr>", {desc="test last"})
-- vim.keymap.set("n", "<leader>ctk", "<cmd>lua require('neotest').run.stop()<cr>", {desc="kill tests"})
vim.keymap.set("n", "<leader>ctk", "<cmd>lua overseer_stop_tests()<cr>", {desc="kill tests"})
vim.keymap.set("n", "<leader>ctp", "<cmd>lua require('neotest').output.open()<cr>", {desc="test output in popup"})
vim.keymap.set("n", "<leader>cto", "<cmd>lua overseer_display_latest_test_output()<cr>", {desc="open test output"})
vim.keymap.set("n", "<leader>cts", "<cmd>lua require'neotest'.summary.toggle()<cr>", {desc="open test output"})
