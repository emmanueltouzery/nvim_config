...
function _G.quick_set_ft()
  local filetypes = {"typescript", "json", "elixir", "rust", "lua", "diff", "sh", "markdown", "html", "config", "sql", "strace", "xml", "other", "logcat", "astgrep"}
...
vim.keymap.set("n", "<leader>od", function() require('apidocs').apidocs_open() end, {desc = "Open devdocs"})
