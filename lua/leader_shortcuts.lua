...
vim.keymap.set("n", "<leader>jlt", function() vim.cmd[[OverseerToggle]]; vim.cmd[[sleep 10m | execute "normal \<C-w>="]] end, {desc="Jobs List Toggle"})
vim.keymap.set("n", "<leader>jlo", function() vim.cmd[[OverseerOpen]]; vim.cmd[[sleep 10m | execute "normal \<C-w>="]] end, {desc="Jobs List Open"})
