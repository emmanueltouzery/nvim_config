...
vim.keymap.set('n', '<leader>cxi', ":lua elixir_insert_inspect()<cr>", {desc="elixir add inspect"})
-- vim.keymap.set('v', '<leader>cxi', ":lua elixir_add_inspect_sel()<cr>", {desc="elixir add inspect"})
