...
vim.keymap.set('n', '<leader>cxiv', ":lua elixir_insert_inspect_value()<cr>", {desc="elixir add inspect value"})
vim.keymap.set('n', '<leader>cxip', ":lua elixir_insert_inspect_param()<cr>", {desc="elixir add inspect parameter"})
vim.keymap.set('n', '<leader>cxif', ":lua elixir_insert_inspect_field()<cr>", {desc="elixir add inspect field"})
require 'key-menu'.set('n', '<Space>cxa', {desc='API'})
vim.keymap.set('n', '<leader>cxai', ":lua elixir_view_docs()<cr>", {desc="elixir apidocs (in cur buffer)"})
vim.keymap.set('n', '<leader>cxap', ":lua elixir_view_docs({popup=true})<cr>", {desc="elixir apidocs (popup)"})
