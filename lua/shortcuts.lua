...
vim.keymap.set('n', 'šh', function() require("gitsigns").nav_hunk('prev', {target = 'all'}) end, {desc="Previous git hunk"})
vim.keymap.set('n', 'đh', function() require("gitsigns").nav_hunk('next', {target = 'all'}) end, {desc="Next git hunk"})
